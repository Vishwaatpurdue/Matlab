...
%   UNIMATE PUMA 560 robot.(Left had Robot)
%
%   Author: Vishveswaran Jothi
%   email: vjothi@purdue.edu date:   12/20/2016
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Copyright (C) 2016, by VISHVESWARAN JOTHI
%
% This file is part of PURDUE-ART (PURDUE Robotics Toolbox for Education & Research).
% 
...
%KINEMATICS
robot.name= 'puma_560L';

robot.DH.theta = '[q(1) q(2) q(3) q(4) q(5) q(6)]';
robot.DH.d='[0  0.14909   0  0.43307     0    0.045]';
robot.DH.a='[0 0.4318  -0.0203      0       0    0]';
robot.DH.alpha= '[-pi/2  0   pi/2  -pi/2   pi/2 0]';

robot.J=[];
robot.name='Puma 560 robotic left arm';

robot.inversekinematic_fn = 'inversekinematic_puma560L(robot, T, choice)';
...
robot.graphical.color = [150 255 130]./255;
%for transparency
robot.graphical.draw_transparent=10;
%draw DH systems
...
robot.motors.G=[62.6111 107.815 53.7063 76.0364 71.923 76.686];
% Some q values to visualize
qr = [0 pi/2 -pi/2 0 0 0]; % ready pose, arm up
qs = [0 0 pi/2 0 0 0]; % Arm streched
